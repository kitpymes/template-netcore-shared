...
namespace Kitpymes.Core.Shared
{
    ...
    */
    ...
    public static class EnumerableExtensions
    {
        ...
        => string.Join(separator, enumerable.ToIsNullOrEmptyThrow(nameof(enumerable)).ToArray());
        ...
        => assemblies.ToIsNullOrAnyThrow(nameof(assemblies)).Select(assembly => assembly.ToAssembly());
    }
}
